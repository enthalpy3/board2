function check() {
	...
	if (!pwReg.test($("input[name=pass]").val())) {
		alert("비밀번호는 8~20자 영문자 또는 숫자이어야 합니다. 특수문자가능");
		return false;
